...
def read_forcebal_1d_file(fname):
    fid = open(fname,"r")
    lines = fid.readlines()
...
def read_forcebal_sum_file(fname):
    forcebal = get_forcebal_vars()
...
def read_forcebal_cdf_file(fname):
    forcebal = get_forcebal_vars()
...
if __name__ == "__main__":
   ...
   #read_forcebal_1d_file(fname)
    fname = "sum_84713_02080_a02.dat"
    read_forcebal_sum_file(fname)
   #fname = "cdf_84713_02080_a02.nc"
   #read_forcebal_cdf_file(fname)
